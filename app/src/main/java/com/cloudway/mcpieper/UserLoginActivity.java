...
public class UserLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                URL url = new URL("http://jusax.dnshome.de/s/sani.php?d=&act=nt&un="+"Till"+"&key="+mPassword);
                ...
                try {
                    ...
                    if (total.toString().contains("901")) {
                        ...
                        Snackbar.make(mEmailView, answrs[new Random().nextInt(answrs.length)], Snackbar.LENGTH_LONG)
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                 startActivity(new Intent(UserLoginActivity.this, NotificationMgr.class));
            } else {
